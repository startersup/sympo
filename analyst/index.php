...
<head>
     ...
     <nav class="navbar navbar-default navit navbar-fixed-top">
      ...
      <div class="tabbable-line">
        ...
        <div class="tab-content">
          ...
          <p>
            A two round enthusiastic event that requires your wise decision making
  capacity and good communication skill. The prelims will consist of question
  ...
  Max. number of participants: Three or Four	</p>
          ...
          <div class="tab-pane" id="tab_default_2">
              ...
              <h3>Round One: Pen and paper</h3>
          <p>    It is a Pen and Paper round, in which a set of question will be provided to the
team. The question will predominantly focus on aptitude, petroleum and petro-
chemical domain.
The teams with high point will qualify to the finals.</p>
              <h3>Round Two: Group Discussion</h3>
          <p>  The shortlisted team will represent an organisation and will have a group
discussion about the alternative best solution for the given industrial problem..</p>
