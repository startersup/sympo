		...
		<div class="modal-dialog" role="document">
			<div class="modal-content">
				...
				<div class="modal-body">
                    ...
                    <div class="row">
              <div class="col-md-6"><center><form method="post" action="TxnTest.php"><input class="form-control" type="hidden" value="200" name="amount"><button class="form-control"><img src="../assets/images/debit-card%20(1).png"></button></form><br><p>Online</p></a></center></div>
