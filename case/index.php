    ...
    <body style="background-color:#000000;opacity:0.8;">
     <nav class="navbar navbar-default navit navbar-fixed-top">
        ...
        <section class="container">
             <div class="shadow">
            <center><img class="spot" src="../assets/images/case.png">
             <p>Case study requires a good team work and wise technical judgments for solving the given problem. The participants are presented with a challenging real-life problem statement concerned to the field of Oil and Gas. They are obliged to provide an alternative best solution for the given problem through the analytical and technical knowledge.</p>
