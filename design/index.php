...
<p>A group of two or three members will be requested to pick a number from a draw and
a design question will be provided for their respective number drawn. The participants
have to identify and design a process flow diagram (PFD) with given equipment for
the required process.
The participants will also have to design the equipment used in their flow diagram.
The team can use any kind of references.<p>

<h3>Round Two: Presentation</h3>
<p>On the next day, the participants are required to present their process flow diagram
and explain their design clearly in front of judges.
Judges decision will be final.</p>
